...
using UniversityHelper.NotificationService.Data.Provider.MsSql.Ef;
using UniversityHelper.NotificationService.Models.Dto.Configurations;
...
namespace UniversityHelper.NotificationService;
...
public class Startup : BaseApiInfo
{
  ...
  public Startup(IConfiguration configuration)
  {
    ...
    Version = "2.0.2.0";
    Description = "NotificationService is an API intended to work with the user rights.";
  ...
  {
    app.UpdateDatabase<NotificationServiceDbContext>();
